  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 40, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{
        ...
        <p><strong>Purpose:</strong> This study examines how people make choices between two options over time. You will press keys on your keyboard to earn points.</p>

        <p><strong>Procedure:</strong> You will see two panels on screen, each linked to a key on your keyboard. Pressing a key may earn you points. The study consists of several phases and takes approximately 30-60 minutes to complete.</p>

        <p><strong>Risks:</strong> There are no known risks beyond those of everyday computer use. You may experience mild fatigue from the repetitive key-pressing task.</p>
